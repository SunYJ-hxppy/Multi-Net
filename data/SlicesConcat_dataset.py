...
class SlicesConcatdataset(BaseDataset):
    def __init__(self, opt):
        BaseDataset.__init__(self, opt)
        self.dir_train = "/data/final_dataset_less_opendataset/train/" 
        data_lists = os.listdir(self.dir_train)
        data_lists.sort()
    ...
    def __getitem__(self, idx):
        ...
        class_GM  = torch.where( mask_tensor == 2, one, zero ) 
        ...
        class_GM_pred  = torch.where( pred_motion_mask_tensor == 2, one, zero ) 
