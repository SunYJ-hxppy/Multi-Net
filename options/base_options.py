...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=str, default='2,4', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='SlicesConcat', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        ...
        parser.add_argument('--epoch', type=str, default='300', help='which epoch to load? set to latest to use latest cached model')
